# Ticket Refinement Runbook v2.3
...
**Research note:** For research tickets, use the research-first prompts and guardrails in `ticket-refinement-runbook-research-companion.md` (same directory).
...
1. Copy `praxis-ai/templates/runbooks/issue-nucleus.md` → `1.10-issue-nucleus.md`
...
1. Ask clarifying questions needed to make the draft reviewable.
   - For `Ticket type: research`, prefer research framing (see `ticket-refinement-runbook-research-companion.md`).
...
6. Generate `1.20-issue-draft.md`:
   - Copy the appropriate GitHub issue template:
     - Feature: `praxis-ai/templates/runbooks/github-issue-feature.md`
     - Research: `praxis-ai/templates/runbooks/github-research-issue.md`
...
If `Ticket type: research`, treat this phase as **AI Research Execution Readiness Review** (see `ticket-refinement-runbook-research-companion.md`).
...
For research tickets, also ensure outputs are PKDP-ready (see `ticket-refinement-runbook-research-companion.md`).
