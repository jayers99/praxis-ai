...
**Companion to:** `ticket-refinement-runbook.md` (see "Knowledge Gap Detection" section)
...
Place handoff doc in the feature's WIP folder:
- `bench/wip/<feature-slug>/X.XX-research-handoff-<gap-id>.md`
