...
<!--
metadata:
  id: ai-guards-user-directives-2024-12-24
  title: CLAUDE.md Directives Research
  date: 2024-12-24
  author: research-librarian
  status: approved
  topic: ai-guards
  also_relevant: [patterns]
  keywords: [claude-md, directives, instruction-files, best-practices, user-preferences, ai-guards]
  consensus: medium
  epistemic_standard: survey
  sources_count: 10
  supersedes: null
  related: [ai-guards-first-principles-2024-12-24, ai-guards-rules-analysis-2024-12-24]
  approved_by: human
...
- Comprehensive catalog of CLAUDE.md directives from Claude Code experts and power users
- Organized by category: communication, planning, code quality, testing, git, errors, context, safety, tools, docs, workflows
- Use as a reference when building user-level CLAUDE.md files
- Evaluate against first principles (simple, positive, under budget) before adopting

## Consensus Rating

**Medium**: Derived from practitioner experience and community best practices. Not academically validated, but reflects working patterns from active users.
...
1. [ctoth's Global CLAUDE.md](https://gist.github.com/ctoth/d8e629209ff1d9748185b9830fa4e79f) — Extensive epistemic and verification rules
2. [tsdevau's Claude Rules Template](https://gist.github.com/tsdevau/673876d17d344f97ba3473bc081bd1e5) — Project template with validation checkpoints
3. [awesome-claude-md](https://github.com/josix/awesome-claude-md) — Curated collection of exemplary files
4. [Harper Reed's Blog](https://harper.blog/2025/05/08/basic-claude-code/) — TDD and stylistic preferences
5. [Sidetool Power Users Guide](https://www.sidetool.co/post/claude-code-best-practices-tips-power-users-2025/)
6. [Huikang's Mature Codebase Guide](https://blog.huikang.dev/2025/05/31/writing-claude-md.html)
7. [Paul Brodner's Tips & Tricks](https://paulbrodner.github.io/2025/claude-code-tips-tricks/)
8. [JohnOct's Lessons Learned](https://johnoct.github.io/blog/2025/08/01/claude-code-best-practices-lessons-learned/)
9. [Anthropic's Official Best Practices](https://www.anthropic.com/engineering/claude-code-best-practices)
10. [HumanLayer's CLAUDE.md Guide](https://www.humanlayer.dev/blog/writing-a-good-claude-md)

---

_Migrated from research/ai-guards/user-directives-research.md_
