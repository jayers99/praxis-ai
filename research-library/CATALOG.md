...
|----|-------|-------|-----------|------|
| [ai-guards-first-principles-2024-12-24](ai-guards/first-principles.md) | AI Memory: First Principles & Best Practices | ai-guards | High | 2024-12-24 |
...
| [roles-decision-hats-2025-12-28](roles/decision-hats.md) | Decision Record - Roles vs Hats Terminology | roles | High | 2025-12-28 |
| [roles-example-flow-2025-12-28](roles/example-flow.md) | Example - Praxis Roles in Action | roles | Medium | 2025-12-28 |
...
|----|-------|-----------|----------|
| [ai-guards-first-principles-2024-12-24](ai-guards/first-principles.md) | AI Memory: First Principles & Best Practices | High | ai-memory, context-window, instruction-files, token-budget |
| [ai-guards-user-directives-2024-12-24](ai-guards/user-directives-research.md) | CLAUDE.md Directives Research | Medium | claude-md, directives, best-practices |
| [ai-guards-rules-analysis-2024-12-24](ai-guards/analysis-user-models.md) | Model File Rules Analysis | Medium | rules-analysis, first-principles, instruction-budget |
| [ai-guards-design-notes-2024-12-24](ai-guards/capture-notes.md) | AI Guards Capture & Design Notes | Low | design-notes, capture, environment, composition |
...
| ID | Title | Consensus | Keywords |
|----|-------|-----------|----------|
| [foundations-research-library-design-2025-12-30](foundations/research-library-design.md) | Research Library Design Principles for AI Agents _(cross-listed)_ | High | research-library, knowledge-management, findability |
...
- [CLAUDE.md Directives Research](ai-guards/user-directives-research.md) — ai-guards — claude-md, directives
- [Model File Rules Analysis](ai-guards/analysis-user-models.md) — ai-guards — rules-analysis
- [Human Intent vs AI Throughput Research](foundations/human-ai-intent-maintenance.md) — foundations — human-ai-collaboration
- [Example: Praxis Roles in Action](roles/example-flow.md) — roles — example, workflow
- [Worked Example: Iteration vs Sustain](spec/sustain-worked-example.md) — spec — sustain, iteration
...
| 2025-12-28 | [Lifecycle Stage Research Report](spec/lifecycle-research.md) | spec |
| 2025-12-28 | [Domain Definitions Research Report](spec/domains-research.md) | spec |
| 2025-12-28 | [Rationale for Praxis Roles Architecture](roles/rationale.md) | roles |
| 2025-12-26 | [Human Intent vs AI Throughput Research](foundations/human-ai-intent-maintenance.md) | foundations |
| 2024-12-24 | [AI Memory: First Principles & Best Practices](ai-guards/first-principles.md) | ai-guards |
