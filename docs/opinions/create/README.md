...
| [render-run](render-run.md)           | render run, render-run, manifest, prepare, generate, batch, run folder, outputs, artifacts, prompts.txt                                                        | Create↔Render Run: how Create projects call Render Run and how runs are stored and reviewed        |
