...
def test_catalog_artifact_success(valid_artifact: Path, research_library: Path) -> None:
...
def test_catalog_artifact_duplicate_id(valid_artifact: Path, research_library: Path) -> None:
    ...
    content = content.replace("roles-new-artifact-2026-01-04", "existing-artifact-2026-01-02")
...
def test_catalog_artifact_creates_topic_folder(valid_artifact: Path, research_library: Path) -> None:
