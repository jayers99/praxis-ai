...
**Draft v2** — Revised based on technical review feedback  
**Date:** 2025-01-23  
**Word count:** ~1720
...
**Changelog from v1:**
- Added specifics to observability (p50/p95/p99 latency percentiles, structured logging)
- Added traffic shadowing to progressive delivery techniques
- Expanded on data characteristics as a difference between staging and prod
- Added pre-deployment verification to risk management
- Added team access as a maturity gate (Ops-only deployment as blocker)
- Clarified maturity model with concrete timings and transition requirements
- Fixed typo in payment processor example

**Status:** Draft v2 complete, ready for manager review  
**Next:** Incorporate manager feedback → Draft v3 (final)
