...
- **Supply chain attacks:** No artifact signing or provenance attestation (yet—see Roadmap)
...
See [SECURITY.md](SECURITY.md) for private reporting instructions and coordinated disclosure policy.

---

## Contributing

See [CONTRIBUTING.md](CONTRIBUTING.md) for the issue workflow, labels, development guidelines, and Contributor License Agreement (CLA) terms.

**By contributing to this project, you agree to the CLA terms granting copyright and patent licenses to the project owner, including the right to relicense your contributions.** This is intentionally owner-favorable to preserve flexibility for future licensing decisions. See CONTRIBUTING.md for full details.
